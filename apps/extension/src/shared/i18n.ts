...
const EXTENSION_MESSAGES = {
  en: {
    ...
    popupRecordTabVideo: "Record tab video in Full mode",
    popupStop: "Stop",
    popupExport: "Export",
    ...
    popupIncludeScreenRecordings: "Include screen recordings in export",
  ...
  "zh-CN": {
    ...
    popupRecordTabVideo: "完整模式录制当前标签页视频",
    popupStop: "停止",
    popupExport: "导出",
    popupSessions: "会话",
    popupOptions: "设置",
    ...
    popupIncludeScreenRecordings: "导出时包含录屏",
