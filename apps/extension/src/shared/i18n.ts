...
const EXTENSION_MESSAGES = {
  en: {
    ...
    popupExportPassphraseBody: "Optional AES-GCM passphrase. Leave blank for unencrypted export.",
    ...
    sessionsExportDialogBody: "Optional AES-GCM passphrase. Leave blank for unencrypted export.",
  ...
  "zh-CN": {
    ...
    popupExportPassphraseBody: "可选的 AES-GCM 口令。留空则导出为未加密归档。",
    ...
    sessionsExportDialogBody: "可选的 AES-GCM 口令。留空则导出为未加密归档。",
